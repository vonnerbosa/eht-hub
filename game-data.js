...
const ITEM_PVP={
  colosseum:[{n:'Laurel Wreath of Destruction',s:'Hat',t:'S (PvP)'},{n:'Ultimate Valhalla',s:'Weapon',c:'Berserker',t:'S (PvP)'},{n:'Vijaya',s:'Weapon',c:'Ranger',t:'S (PvP)'},{n:'Ultimate Immortal',s:'Weapon',c:'Sorcerer',t:'S (PvP)'},{n:'Laurel Wreath of Protection',s:'Hat',t:'S (PvP)'},{n:'Mjolnir',s:'Weapon',c:'Paladin',t:'S (PvP)'},{n:'Ultimate Vijaya',s:'Weapon',c:'Ranger',t:'S (PvP)'},{n:'Trishula',s:'Weapon',c:'Dark Knight',t:'S (PvP)'},{n:'Valhalla',s:'Weapon',c:'Berserker',t:'S (PvP)'},{n:'Ultimate Mjolnir',s:'Weapon',c:'Paladin',t:'S (PvP)'},{n:'Immortal',s:'Weapon',c:'Sorcerer',t:'S (PvP)'},{n:'Ultimate Trishula',s:'Weapon',c:'Dark Knight',t:'S (PvP)'}],
  champion:[{n:'Blue Battle Circlet',s:'Hat',t:'SS (PvP)'},{n:'Truthful Fenrir',s:'Weapon',c:'Berserker',t:'SS (PvP)'},{n:'Truthful Vijaya',s:'Weapon',c:'Ranger',t:'SS (PvP)'},{n:'Truthful Isis',s:'Weapon',c:'Sorcerer',t:'SS (PvP)'},{n:'Red Battle Circlet',s:'Hat',t:'SS (PvP)'},{n:'Truthful Mjolnir',s:'Weapon',c:'Paladin',t:'SS (PvP)'},{n:'Truthful Gandiva',s:'Weapon',c:'Ranger',t:'SS (PvP)'},{n:'Truthful Trishula',s:'Weapon',c:'Dark Knight',t:'SS (PvP)'},{n:'Truthful Valhalla',s:'Weapon',c:'Berserker',t:'SS (PvP)'},{n:'Truthful Mahes',s:'Weapon',c:'Paladin',t:'SS (PvP)'},{n:'Truthful Immortal',s:'Weapon',c:'Sorcerer',t:'SS (PvP)'},{n:'Truthful Gungnir',s:'Weapon',c:'Dark Knight',t:'SS (PvP)'}],
...
const ITEM_BOSS={
  ss:[{n:'Venom Staff',s:'Weapon',t:'SS (Boss)'},{n:'Venom Bow',s:'Weapon',t:'SS (Boss)'},{n:'Darkness Spear',s:'Weapon',t:'SS (Boss)'},{n:'Darkness Staff',s:'Weapon',t:'SS (Boss)'},{n:'Venom Blade',s:'Weapon',t:'SS (Boss)'},{n:'Venom Pike',s:'Weapon',t:'SS (Boss)'},{n:'Darkness Sword',s:'Weapon',t:'SS (Boss)'},{n:'Venom Scythe',s:'Weapon',t:'SS (Boss)'},{n:'Darkness Bow',s:'Weapon',t:'SS (Boss)'},{n:'Darkness Hammer',s:'Weapon',t:'SS (Boss)'}],
